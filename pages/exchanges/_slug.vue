<template>
	<div class="topBodyWrapper">
		<div class="sectionWrapper wrapper792" style="margin-bottom: 100px">
			...
			<div v-else style="height: 400px; display: flex; justify-content: center; align-items: center; font-size: 48px">
				No content
			</div>
		</div>
		<CountMeInSection />
...
@Component({
	components: { ContentBody, CountMeInSection },
...
export default class ExchangeView extends Vue {
	...
	get targetContent(): ICommonContent | null {
		return this.exchanges?.content || this.defaultExchanges?.exchange || null;
	}
